# Number of CPUs to be allocated to the virtual machine. (Default: 2)
cpu: 8

# Size of the disk in GiB to be allocated to the virtual machine. (Default: 60)
#
# NOTE: value can only be increased after virtual machine has been created.
disk: 200

# Size of the memory in GiB to be allocated to the virtual machine. (Default: 2)
memory: 48

# Architecture of the virtual machine (x86_64, aarch64, host). (Default: host)
#
# NOTE: value cannot be changed after virtual machine is created.
arch: host

# Container runtime to be used (docker, containerd). (Default: docker)
#
# NOTE: value cannot be changed after virtual machine is created.
runtime: docker

# Set custom hostname for the virtual machine. (Default: colima)
hostname: colima
